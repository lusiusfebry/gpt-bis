...
function FamilyInfoTab({ data, onSave, employeeId }: FamilyInfoTabProps) {
  ...
  const collapseItems = useMemo(
    () => [
        ...
        children: (
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
            ...
            <Form.Item label="Jumlah Anak" name={["family", "jumlah_anak"]}>
              <InputNumber min={0} className="w-full" placeholder="Jumlah anak tersinkron otomatis" readOnly disabled />
            </Form.Item>
            <Form.Item label="Keterangan Pasangan" name={["family", "keterangan_pasangan"]} className="lg:col-span-2">
            ...
            {(fields, { add, remove }) => (
              <div className="space-y-4">
                {fields.map((field, index) => (
                  <Card key={field.key} size="small" title={`Anak ${index + 1}`}>
                    <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
                      <Form.Item
                        label="Nama Anak"
      ...
      {
        key: "identitas-saudara-kandung",
        label: "Identitas Saudara Kandung",
        children: (
          <Form.List name="siblings">
            {(fields, { add, remove }) => (
              <div className="space-y-4">
                {fields.map((field, index) => (
                  <Card key={field.key} size="small" title={`Saudara Kandung ${index + 1}`}>
                    <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
                      <Form.Item
        ...
        children: (
          <Space direction="vertical" size={24} className="flex w-full">
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
              ...
              <Form.Item label="Keterangan Ayah Mertua" name={["family", "keterangan_ayah_mertua"]} className="lg:col-span-2">
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
              ...
              <Form.Item label="Keterangan Ibu Mertua" name={["family", "keterangan_ibu_mertua"]} className="lg:col-span-2">
  ...
  return (
    <Card bordered={false} className="shadow-none">
      ...
      >
        <Collapse defaultActiveKey={["pasangan"]} items={collapseItems} />
