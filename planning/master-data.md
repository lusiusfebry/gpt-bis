...
### Divisi
- **code**: `DIV-xxxxx` (autogenerated, immutable, cannot be changed)
- **nama divisi**: Teks
- **keterangan**: Teks
- **status**: Pilihan (Aktif/Tidak Aktif), default: `Aktif`

### Department
- **code**: `DEP-xxxxx` (autogenerated, immutable, cannot be changed)
- **nama departmen**: Teks
...
### Posisi Jabatan
- **code**: `POS-xxxxx` (autogenerated, immutable, cannot be changed)
...
### Kategori Pangkat
- **code**: `KPG-xxxxx` (autogenerated, immutable, cannot be changed)
- **nama kategori pangkat**: Teks
- **keterangan**: Teks
- **status**: Pilihan (Aktif/Tidak Aktif), default: `Aktif`

### Golongan
- **code**: `GOL-xxxxx` (autogenerated, immutable, cannot be changed)
- **nama golongan**: Teks
- **keterangan**: Teks
- **status**: Pilihan (Aktif/Tidak Aktif), default: `Aktif`

### Sub Golongan
- **code**: `SGO-xxxxx` (autogenerated, immutable, cannot be changed)
- **nama sub golongan**: Teks
- **keterangan**: Teks
- **status**: Pilihan (Aktif/Tidak Aktif), default: `Aktif`

### Jenis Hubungan Kerja
- **code**: `JHK-xxxxx` (autogenerated, immutable, cannot be changed)
- **nama jenis hubungan kerja**: Teks
- **keterangan**: Teks
- **status**: Pilihan (Aktif/Tidak Aktif), default: `Aktif`

### Tag
- **code**: `TAG-xxxxx` (autogenerated, immutable, cannot be changed)
- **nama tag**: Teks
...
### Lokasi Kerja
- **code**: `LKR-xxxxx` (autogenerated, immutable, cannot be changed)
...
### Status Karyawan
- **code**: `STK-xxxxx` (autogenerated, immutable, cannot be changed)
- **nama status**: Teks
- **keterangan**: Teks
- **status**: Pilihan (Aktif/Tidak Aktif), default: `Aktif`
